...
## from https://github.com/Digilent/digilent-xdc/blob/master/Arty-S7-50-Master.xdc
...
set_property -dict { PACKAGE_PIN R2    IOSTANDARD SSTL135 } [get_ports { pin_clock }]; #IO_L12P_T1_MRCC_34 Sch=ddr3_clk[200]
create_clock -add -name sys_clk_pin -period 10.000 -waveform {0 5.000}  [get_ports { pin_clock }];
...
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { pin_led }]; #IO_L16N_T2_A27_15 Sch=led[2]
...
set_property -dict { PACKAGE_PIN C18   IOSTANDARD LVCMOS33 } [get_ports { pin_n_reset }]; #IO_L11N_T1_SRCC_15
